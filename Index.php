...
<body>
        ...
        <header class="conteiner">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="./functions/login.php">Музеи</a></li>
                    <li><a href="./functions/login.php">Экспонаты</a></li>
                    <li><a href="./functions/login.php">События</a></li>
                    <li class="btn"><a href="./functions/login.php">Войти</a></li>
        ...
        <div class="conteiner trending">
            ...
            <div class="museum">
                ...
                <div class="ff">
                    ...
                    <span class="fire"><img src="img/fire.svg" alt="">90 посещений</span>
                </div>
                <div class="ff">
                    <div class="block">
                    ...
                    <span class="fire"><img src="img/fire.svg" alt="">80 посещений</span>
    ...
    <div class="wrapper">
        <div class="container projects">
            ...
            <a href="./functions/login.php" class="see--all">Коллекции</a>
        </div>
